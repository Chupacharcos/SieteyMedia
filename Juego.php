 ...
 * @return array
 */
public function cargarBaraja($jugador, $sw)
{
    $baraja = array(
    ...
    if ($entrada == 's') {
        $cartas = $this->barajarCartas($baraja);
 ...
 * @return array
 */
private function barajarCartas($baraja)
{
    $cartas = array();
 ...
 * @return float
 */
public function jugar($jugador, $baraja)
{
    $puntos = 0;
    $cartasUsadasJg = array();

    do {
        $puntos = $this->sacarCarta($jugador, $baraja, $cartasUsadasJg, $puntos, true);
        if ($puntos < 7.5) {
            do {
 ...
 * @return float
 */
public function jugarIA($jugador, $baraja, $puntosJg)
{
    $puntos = 0;
    $cartasUsadasIA = array();

    do {
        $puntos = $this->sacarCarta($jugador, $baraja, $cartasUsadasIA, $puntos, false);
 ...
 * @return float
 */
private function sacarCarta($jugador, &$baraja, &$cartasUsadas, $puntos, $sw)
{
 ...
 * @return string
 */
public function comprobarGanador($puntosJg, $puntosIA, $jugador)
{
